...
async function POST(req) {
    try {
        ...
        // Find and verify OTP
        const otpRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OTP$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email,
            otp,
            expiresAt: {
                $gt: new Date()
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])(email, name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__244c3013._.js.map