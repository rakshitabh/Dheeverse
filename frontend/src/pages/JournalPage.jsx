...
const emotions = ['happy', 'calm', 'sad', 'anxious', 'angry', 'neutral', 'grateful', 'hopeful'];
const entryTypes = [
      ...
      {filteredEntries.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            {hasActiveFilters ? 'Try adjusting your filters' : 'Start your wellness journey by creating your first entry'}
          </p>
          {!hasActiveFilters && (
            <Button className="mt-4" asChild>
              <Link to="/journal/new">Create Entry</Link>
            </Button>
          )}
        </div>
      ) : viewMode === 'grid' ? (
